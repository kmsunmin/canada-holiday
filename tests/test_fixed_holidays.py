...
class TestFixedDateHolidays:
    def test_all_fixed_date_holidays_common_to_all_provinces_are_returned(self):
        """
        ...
        expected_fixed_holidays = convert_fixture_data_to_holidays_list(expected_data_raw["common_to_all_provinces"])
